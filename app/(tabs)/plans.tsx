...
export default function PlansScreen() {
  ...
  const [deadlines, setDeadlines] = useState<PlanItem[]>([]);
  ...
  const counts = useMemo(() => {
    return {
      ...
      ACTIVE: deadlines.filter((i) => i.category === 'ACTIVE').length,
      AT_RISK: deadlines.filter((i) => i.category === 'AT_RISK').length,
      COMPLETED: deadlines.filter((i) => i.category === 'COMPLETED').length,
    };
  }, [deadlines]);
  ...
  }, [deadlines, selectedFilter, searchQuery]);
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.listContainer}>
          {loading && <Text style={styles.emptySubtitle}>Loading plans…</Text>}
